...
def main_menu(user_id: int) -> ReplyKeyboardMarkup:
    rows = [
        [KeyboardButton(text="🛍️ PRODUCTS"), KeyboardButton(text="🎁 FREE ITEMS")],
        [KeyboardButton(text="📝 PREORDER"), KeyboardButton(text="👥 REFERRAL")],
...
USER_MENU_TEXTS = {
    ...
    "🎁 FREE ITEMS", "📝 PREORDER", "👑 ADMIN PANEL", "💱 EXCHANGE POINTS",
}
