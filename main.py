...
async def preorder_reject(callback: CallbackQuery) -> None:
    ...
    await safe_send_message(pre["user_id"], f"❌ Your preorder {code(short_id(pre['_id']))} was rejected. Contact support for details.", reply_markup=await contact_keyboard())
